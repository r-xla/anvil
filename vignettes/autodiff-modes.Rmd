...
For computational feasability, we want to avoid calculating the full intermediate matrices, as these can be very large.
...
But the rightmost multiplication involes the derivative of $f$ with respect to the temporary variables $z$.
