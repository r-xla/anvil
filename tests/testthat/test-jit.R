...
test_that("ambiguous and non-ambiguous inputs generate different executables", {
  ...
  expect_equal(result3, nv_tensor(12.0, dtype = "f32")) # trace_count is now 2
  expect_equal(trace_count, 2)
