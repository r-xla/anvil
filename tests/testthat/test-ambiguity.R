...
test_that("JIT propagates ambiguity from inputs to outputs", {
  ...
  expect_equal(as_array(result_amb), 3.0)
  ...
  expect_equal(as_array(result_mixed), 3.0)
  ...
  expect_equal(as_array(result_nonamb), 3.0)
})
...
test_that("JIT handles constants with ambiguity", {
  ...
  expect_equal(as_array(result), 11.0)
  ...
  expect_equal(as_array(result2), 11.0)
})
