...
prim_add[["reverse"]] <- function(inputs, outputs, grads, .required) {
  grad <- grads[[1L]]
  list(
    if (.required[[1L]]) grad,
    if (.required[[2L]]) grad
...
prim_mul[["reverse"]] <- function(inputs, outputs, grads, .required) {
  lhs <- inputs[[1L]]
  rhs <- inputs[[2L]]
  grad <- grads[[1L]]
  list(
...
prim_sub[["reverse"]] <- function(inputs, outputs, grads, .required) {
  grad <- grads[[1L]]
  list(
    if (.required[[1L]]) grad,
...
prim_negate[["reverse"]] <- function(inputs, outputs, grads, .required) {
  grad <- grads[[1L]]
  list(
...
prim_div[["reverse"]] <- function(inputs, outputs, grads, .required) {
  rhs <- inputs[[2L]]
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_remainder[["reverse"]] <- function(inputs, outputs, grads, .required) {
...
prim_pow[["reverse"]] <- function(inputs, outputs, grads, .required) {
  lhs <- inputs[[1L]]
  rhs <- inputs[[2L]]
  y <- outputs[[1L]]
  grad <- grads[[1L]]
...
prim_log[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_exp[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_sqrt[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_rsqrt[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_tanh[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_tan[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_sine[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx sin(x) = cos(x)
...
prim_cosine[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx cos(x) = -sin(x)
...
prim_acos[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_acosh[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_asin[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_asinh[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_atan[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx atan(x) = 1 / (1 + x^2)
...
prim_atanh[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_cosh[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx cosh(x) = sinh(x)
...
prim_sinh[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx sinh(x) = cosh(x)
...
prim_digamma[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_lgamma[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_polygamma[["reverse"]] <- function(inputs, outputs, grads, .required) {
  n <- inputs[[1L]]
  x <- inputs[[2L]]
  grad <- grads[[1L]]
  list(
...
prim_erf[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_erfc[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_erf_inv[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_dot_general[["reverse"]] <- function(inputs, outputs, grads, contracting_dims, batching_dims, .required) {
  lhs <- inputs[[1L]]
  rhs <- inputs[[2L]]
  grad <- grads[[1L]]
...
prim_transpose[["reverse"]] <- function(inputs, outputs, grads, permutation, .required) {
  grad <- grads[[1L]]
...
prim_reshape[["reverse"]] <- function(inputs, outputs, grads, shape, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_reduce_sum[["reverse"]] <- function(inputs, outputs, grads, dims, drop, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    if (.required[[1L]]) {
...
prim_broadcast_in_dim[["reverse"]] <- function(inputs, outputs, grads, shape, broadcast_dimensions, .required) {
  operand <- inputs[[1L]]
  y <- outputs[[1L]]
  grad <- grads[[1L]]
...
prim_if[["reverse"]] <- function(inputs, outputs, grads, true, false, node_map, .required) {
  cli_abort("Not yet implemented")
}

# convert reverse -----------------

prim_convert[["reverse"]] <- function(inputs, outputs, grads, dtype, ambiguous, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
...
prim_expm1[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx (exp(x) - 1) = exp(x)
...
prim_log1p[["reverse"]] <- function(inputs, outputs, grads, .required) {
  operand <- inputs[[1L]]
  grad <- grads[[1L]]
  list(
    # d/dx log(1 + x) = 1 / (1 + x)
...
prim_logistic[["reverse"]] <- function(inputs, outputs, grads, .required) {
  y <- outputs[[1L]]
  grad <- grads[[1L]]
  list(
...
prim_clamp[["reverse"]] <- function(inputs, outputs, grads, .required) {
  min_val <- inputs[[1L]]
  operand <- inputs[[2L]]
  max_val <- inputs[[3L]]
  y <- outputs[[1L]]
...
prim_reverse[["reverse"]] <- function(inputs, outputs, grads, dims, .required) {
  grad <- grads[[1L]]
  list(
...
prim_reduce_all[["reverse"]] <- function(inputs, outputs, grads, dims, drop, .required) {
  operand <- inputs[[1L]]
  list(
...
prim_atan2[["reverse"]] <- function(inputs, outputs, grads, .required) {
  lhs <- inputs[[1L]]
  rhs <- inputs[[2L]]
  grad <- grads[[1L]]
  if (.required[[1L]] || .required[[2L]]) {
...
prim_dynamic_slice[["reverse"]] <- function(inputs, outputs, grads, slice_sizes, .required) {
  operand <- inputs[[1L]]
...
prim_dynamic_update_slice[["reverse"]] <- function(inputs, outputs, grads, .required) {
  update <- inputs[[2L]]
...
prim_cholesky[["reverse"]] <- function(inputs, outputs, grads, lower, .required) {
  if (!.required[[1L]]) {
    return(list(NULL))
  }
...
prim_triangular_solve[["reverse"]] <- function(
  inputs,
  outputs,
  grads,
  left_side,
