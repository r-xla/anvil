...
Creates a new [`Graph`](AnvilGraph.md) which is afterwards accessible
via [`.current_descriptor()`](dot-current_descriptor.md). The graph is
...
- envir:
  ...
  [`Graph`](AnvilGraph.md) if it was not returned yet.

## Value

A [`Graph`](AnvilGraph.md) object.
