...
This package provides a code transformation framework in R.
It currently provides support for jit compilation and backward-mode automatic differentiation.
...
Through automatic differentiation, we can also obtain the gradient of the function.
