...
It can be executed in either *eager* mode (each operation is compiled and run immediately) or *jit* mode (the whole function is compiled into a single kernel via `jit()`).
