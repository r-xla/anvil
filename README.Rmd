...
You can also use one of the prebuilt [Docker images](https://github.com/r-xla/docker).
...
For more details, see the [Installation](https://r-xla.github.io/anvil/articles/installation.html) vignette.
