...
For more complex examples, see the package website, where we, e.g., show [how to implement a Gaussian Process](https://r-xla.github.io/anvil/dev/articles/gaussian-process.html).
