...
install.packages("anvil", repos = c("https://r-xla.r-universe.dev", getOption("repos")))
...
We define an R function operating on `AnvilArray`s -- the primary data type of {anvil}.
